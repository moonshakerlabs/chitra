  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // CHITRA Custom Colors
        chitra: {
          pink: "hsl(var(--chitra-pink))",
          "pink-light": "hsl(var(--chitra-pink-light))",
          "pink-dark": "hsl(var(--chitra-pink-dark))",
          rose: "hsl(var(--chitra-rose))",
          blush: "hsl(var(--chitra-blush))",
        },
        // Mood Colors
        mood: {
